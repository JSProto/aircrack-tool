...
let airmon = {
    ...
    list: function() {
        return this._shell().then(stdOutParser);
    },
    stop: function(interface) {
        return this._shell('stop', ...arguments).then(stdOutParser);
    },
    start: function(interface, channel = null) {
        return this._shell('start', ...arguments).then(stdOutParser);
    },
    check: function() {
        return this._shell('check');
    },
    kill: function() {
        return this._shell('check', 'kill');
    }
};
